"""CLI for inspecting AgentWatch data — alerts, traces, and baselines."""
...
@click.group()
@click.option("--db", default=None, help="Path to AgentWatch database")
@click.pass_context
def cli(ctx: click.Context, db: str | None) -> None:
    """AgentWatch — Real-time drift detection for AI agents."""
